...
<section class="h-100">
        <div class="container h-100">
            ...
            <div class="card-body p-5"><i class="bi bi-award-fill"></i>
                
             <h1 class="fs-4 card-title fw-bold mb-4">Welcome Marvin</i></h1>
             
             
            <form action="principal.php" method="POST" class="needs-validation" novalidate="" autocomplete="off">
            <div class="mb-3">
            <label class="mb-2 text-muted" for="email"><strong>Para el ingreso de datos
          daremos clic en el menu que tenemos en la parte superior derecha.</strong> </label>
            <label class="mb-2 text-muted" for="email"></label>

            <label class="mb-2 text-muted" for="email">Esta es mi creatividad en el laboratorio 1
              mas optimizado - mas limpio.
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <span>Diseño creado por @Marvin Galeano <br>
    Optimizado - diseño - creatividad <br>
    Copyright &copy; Marvin Galeano &mdash; Univo </span>
...
<div class="text-center mt-5 text-muted"><strong> Copyright &copy; Marvin Galeano &mdash; Univo 
                    </div>
                </div>
            </div>
        </div>
