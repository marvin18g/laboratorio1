...
<br>
  <section class="d-flex justify-content-center">
    <div class="card col-sm-6 p-3">
        ...
        <form action="recibirmascota.php" method="post">
        <div class="row">
  ...
  <div class="col">
  <br>
    <input type="text" class="form-control" placeholder="Color" aria-label="color" name="color" id="color">
  </div>
...
<div class="row">
  <div class="col">
  <br>
    <input type="text" class="form-control" placeholder="Raza" aria-label="Raza"name="raza" id="raza" >
  </div>


  <div class="col">
  <br>
    <input type="text" class="form-control" placeholder="Sexo" aria-label="Sexo" name="sexo" id="sexo">
  </div>
</div>
...
<div class="row">
  <div class="col">
  <br>
    <input type="text" class="form-control" placeholder="Peso" aria-label="Peso" name="peso" id="peso">
  </div>


  <div class="col">
  <br>
    <input type="text" class="form-control" placeholder="Altura" aria-label="Altura" name="altura" id="altura">
  </div>
</div>
<div class="row">
  <div class="col">
  ...
  <div class="col">
  <br>
    <input type="text" class="form-control" placeholder="Alimentacion" aria-label="Alimentacion" name="alime" id="alime">
